...
count = pygame.font.SysFont("Verdana", 30)
gravity = pygame.font.SysFont("Verdana", 30)
...
r2 = Rect(420, rng(10, (height-20)), 200, 10)
r3 = Rect(615, rng(10, (height-20)), 100, 10)
r4 = Rect(710, rng(10, (height-20)), 300, 10)
r5 = Rect(1005, rng(10, (height-20)), 200, 10)
r6 = Rect(1200, rng(10, (height-20)), 100, 10)
r7 = Rect(1295, rng(10, (height-20)), 300, 10)
r8 = Rect(1590, rng(10, (height-20)), 200, 10)
r9 = Rect(1785, rng(10, (height-20)), 100, 10)
r10 = Rect(1880, rng(10, (height-20)), 200, 10)
#--------------------------------------------------------------
...
#---------------------------------Blocks----------------------------------
    for rectangle in rect_group:
        if rectangle.rect.right < 0:
            rectangle.rect.y = rng(10, (height-20))
            rectangle.rect.left = last_platform_x
            if 25 > abs((rectangle.rect.y - last_platform_y)):
                rectangle.rect.y = last_platform_y
...
#-----------------------------User Inputs---------------------------------
    for event in pygame.event.get():
        ...
        if cursor1 == True:
            if pygame.mouse.get_pos() == (width-1, 0):
...
#-------------------------------------Loop Updates--------------------------------------
    ...
    Write(count, str(points), yellow, (15, 0), False)
    Write(gravity, ("Gravity Uses: " + str(test)), green, (15, (height-40)), False)
    
    if (points%500) == 0:
        grav_use.rect.x, grav_use.rect.y = 1610, rng(10, (height-60))
    points += 1
#---------------------------------------------------------------------------------------
...
#-----------------------------------------Reset--------------------------------------------
    if player.rect.y > (height + 50) or player.rect.y < (-50):
        screen.fill(black, (0, 0, 1000, 50))
        distance = count.render("You scored " + str(points) + " points", True, yellow)
        ...
        while True:
            ...
            try:
                ...
                if yes_button.rect.collidepoint((pos1, pos2)):
                    ...
                    r2.rect.x, r2.rect.y = 420, rng(10, (height-20))
                    r3.rect.x, r3.rect.y = 615, rng(10, (height-20))
                    r4.rect.x, r4.rect.y = 710, rng(10, (height-20))
                    r5.rect.x, r5.rect.y = 1005, rng(10, (height-20))
                    r6.rect.x, r6.rect.y = 1200, rng(10, (height-20))
                    r7.rect.x, r7.rect.y = 1295, rng(10, (height-20))
                    r8.rect.x, r8.rect.y = 1590, rng(10, (height-20))
                    r9.rect.x, r9.rect.y = 1785, rng(10, (height-20))
                    r10.rect.x, r10.rect.y = 1880, rng(10, (height-20))
